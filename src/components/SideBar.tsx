  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        />
        <path
          d="M10 22.22C9.59 22.22 9.25 21.88 9.25 21.47V16.94C9.25 16.53 9.59 16.19 10 16.19C10.41 16.19 10.75 16.53 10.75 16.94V21.47C10.75 21.89 10.41 22.22 10 22.22Z"
          fill="currentColor"
        />
        <path
        ...
        />
        <path
          d="M19.04 22.22H15.49C12.72 22.22 11.78 21.28 11.78 18.51V12.8C11.78 10.03 12.72 9.09003 15.49 9.09003H19.04C21.81 9.09003 22.75 10.03 22.75 12.8V18.51C22.75 21.29 21.81 22.22 19.04 22.22ZM15.49 10.59C13.53 10.59 13.28 10.84 13.28 12.8V18.51C13.28 20.47 13.53 20.72 15.49 20.72H19.04C21 20.72 21.25 20.47 21.25 18.51V12.8C21.25 10.84 21 10.59 19.04 10.59H15.49Z"
          fill="currentColor"
        />
        <path
...
const Sidebar = ({
  ...
  return (
    ...
    //     <div className="flex items-start justify-start cursor-pointer pt-4 text-[#1D1D1B] text-lg font-semibold">
    //       📔S•T•O•R•Y • H•U•B
    //     </div>
    ...
    //             item.name === activeTab ? "bg-[#1C1442]" : "hover:bg-gray-100"
    //           }`}
    ...
    //     <div className="flex pl-4 font-inter ml-[-8] items-center place-items-end rounded-lg bg-[#E8E9FF] mt-2 cursor-pointer">
    //       <div className="mr-3">
    //         <svg
    //           width="24"
    //           height="24"
    ...
    //         </svg>
    //       </div>
    //       <span className="text-[#1C1D22]">Contact Support</span>
    //     </div>
    //   </div>
    // </div>
    <>
